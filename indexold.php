      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form  action=""  method="post" role="form" id="application_form" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="file" class="form-control" required="" name="profile_image_back" id="profile_image_back" required>
              </div> -->
